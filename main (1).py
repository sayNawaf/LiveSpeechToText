...
class LiveWav2Vec2():
    ...
    def __init__(self, model_name,custom, device_name="default"):
    ...
    def start(self):
        ...
        self.asr_process = threading.Thread(target=LiveWav2Vec2.asr_process, args=(
            self.model_name, self.asr_input_queue, self.asr_output_queue,self.custom))
    ...
    def asr_process(model_name, in_queue, output_queue, custom):
        wave2vec_asr = Wave2Vec2Inference(model_name,custom,use_lm_if_possible=True)
...
if __name__ == "__main__":
    ...
    custom = True
    if not custom:
        modelPath = "facebook/wav2vec2-large-960h-lv60-self"
    else:
        modelPath = "/home/nawaf/Projects/wav2vec2-live-main/checkpoint-6000"

    asr = LiveWav2Vec2(modelPath,custom)
